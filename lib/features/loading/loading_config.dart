...
abstract final class SwordsmanLoadingConfig {
  ...
  // already fully settled by t=.72 of cycleDuration (~2592ms) - revealProgress
  // clamps to 1 and every row's disturbance is frozen by then
  // (swordsman_animation.dart's dissolve interval ends at .72). This is kept
  ...
  static const minimumDisplayDuration = Duration(milliseconds: 2750);
